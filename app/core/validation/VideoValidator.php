...
//        }uki3
     ...
     *       of this subclass VideoValidator.
     */
    protected function set_json_errors_array()
    {
        ...
        foreach (MyValidationErrorLogger::get_log_array() as $log_error_msg) {
            ...
            // Special scenario for the VideoValidator's embed_code CRUD create.
            if ($attr == "src") {
            ...
            // Special scenario for the VideoValidator's embed_code CRUD update.
            if ($attr == "edit_src") {
