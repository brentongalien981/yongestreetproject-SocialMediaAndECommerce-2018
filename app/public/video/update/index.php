...
<!--css / main-->
<link rel="stylesheet" type="text/css" href="<?= CN_URL_PUBLIC . "css/video/update/index.css"; ?>">
...
<!--components / main-->
<?php require_once(PUBLIC_PATH . "video/update/components/main.php"); ?>
...
<!--js / main-->
<script src="<?= CN_URL_PUBLIC . "js/js-controllers/UpdateVideoPageController.js"; ?>" type="module"></script>